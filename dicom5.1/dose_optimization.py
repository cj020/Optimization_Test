...
def main():
    ...
    # ------------------------------------------------------------------
    # 4. Parse RTSTRUCT — identify PTV and OAR
    # ------------------------------------------------------------------
    print("\n" + "=" * 70)
    ...
    # ------------------------------------------------------------------
    # 5. Build binary masks on the RTDOSE grid for PTV and OAR
    # ------------------------------------------------------------------
    print("\n" + "=" * 70)
    ...
    print("=" * 70)
    print(f"  {len(ptv_names)} PTV(s) and {len(oar_names)} OAR(s) identified and rasterized")
